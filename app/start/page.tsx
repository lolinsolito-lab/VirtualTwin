    ...
    const plans = [
        {
            id: 'solopreneur',
            name: 'Solopreneur',
            subtitle: 'Per Freelancer e Coach in P.IVA',
            descLong: 'Entry-level perfetto per liberi professionisti che vogliono automatizzare le risposte.',
            price: currentPricing.prices.solopreneur,
            priceId: currentPricing.stripePriceIds.solopreneur,
            nextPrice: 49,
            messages: '1,000',
        ...
        },
        {
            ...
            descLong: 'Il perfetto equilibrio tra potenza e prezzo. Provato da centinaia di professionisti.',
            socialProof: '⭐ 4.9/5 da 200+ Coach',
            scarcity: '⚡ Ultimi 3 posti Wave Genesis',
            price: currentPricing.prices.entrepreneur,
            priceId: currentPricing.stripePriceIds.entrepreneur,
            nextPrice: nextPricing?.prices.entrepreneur,
            messages: '5,000',
            ...
            badge2: { emoji: '⭐', text: 'SCELTA #1', color: 'gold' }
        },
        {
            id: 'conquistatore',
            name: 'Conquistatore',
            subtitle: 'Per PMI e Agenzie Scale-Up',
